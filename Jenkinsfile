...
environment {
    ...
    GIT_USER_NAME = 'kksshh0612'
    GIT_USER_EMAIL = 'kksshh0612@gmail.com'
    GITHUB_CREDENTIALS_ID = 'Github-Cred'
    GITHUB_REPO = 'github.com/kksshh0612/reqres_products.git'
            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: GITHUB_CREDENTIALS_ID, usernameVariable: 'GIT_USERNAME', passwordVariable: 'GIT_PASSWORD')]) {
                        sh """
                            git config --global user.email "kksshh0612@gmail.com"
                            git config --global user.name "kksshh0612"
